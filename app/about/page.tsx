  ...
  useEffect(() => {
    ...
    if (root) {
      ...
      projectDetails.forEach(project => {
        ...
        appendChild(projectCard, <div className="canopy"><ul><li>Front End Dev</li><li>2023</li></ul></div>);
        appendChild(projectCard, <p className="Tonic-paragraph">{project.description}</p>);
        appendChild(projectCard, <ul className="Tonic-ul"><li>{project.technologies}</li></ul>);
